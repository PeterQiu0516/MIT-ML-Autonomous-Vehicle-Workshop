...
imgsize = (128,96)
windowsize = (50,50)
slidestep = (10, 10) # number of pixels to slide window
min_red_pixels = 30 # min red pixel to process window
...
class SVMCLF():
    def __init__(self):
        ...
        self.K_detthresh_warn = 1.0 # detection threshold (factor of window count)
    ...
    def getFeatures(self,img):
        ...
        #print 'Took %s sec to getFeatures' % (time.time() - start_time)
        return output
